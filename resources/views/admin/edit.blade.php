...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Modifier les informations d' un utilisateur</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-secondary">
            <div class="card-header">
              <h3 class="card-title">Modifier les informations du compte</h3>
            </div>
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action=" /admin/update_user/{{optional($edit)->id}}" method="POST">
                @csrf
              <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <form action="/admin/changePassword/{{optional($edit)->id}}" method="POST">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
